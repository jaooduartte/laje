...
import { updateBracketCompetitionQualification } from "@/domain/championship-brackets/championshipBracket.repository";
...
export function AdminChampionshipQualificationSection({ competitions, isEditable, onSaved }: Props) {
  ...
  async function saveCompetition(competition: ChampionshipBracketCompetition, mode: QualificationModeOption) {
    ...
    const { error } = await updateBracketCompetitionQualification(
      competition.id,
    ...
    toast.success("Formato de classificação atualizado.");
