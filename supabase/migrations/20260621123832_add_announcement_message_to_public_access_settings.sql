...
AS $$
  SELECT
    ...
    public_page_access_settings_table.announcement_message,
...
DROP FUNCTION IF EXISTS public.set_public_access_settings(BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, TEXT);
...
BEGIN
  ...
  normalized_announcement_message := NULLIF(trim(COALESCE(_announcement_message, '')), '');
...
GRANT EXECUTE ON FUNCTION public.set_public_access_settings(BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, TEXT, TEXT) TO authenticated;
