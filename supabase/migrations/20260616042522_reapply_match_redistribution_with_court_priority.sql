-- Reaplica a versão corrigida da redistribuição da agenda, com reserva de
-- quadra por divisão/naipe preferencial no mesmo dia e desempate para jogos
-- mais pressionados pelo descanso mínimo.
