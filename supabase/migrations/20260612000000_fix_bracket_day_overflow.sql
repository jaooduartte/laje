-- Reescreve generate_championship_bracket_groups incorporando todos os patches anteriores
-- (20260524100000 PLANNING→UPCOMING, 20260524110000 should_complete_knockout variable,
--  20260505193000 draft upsert) e adicionando verificação de capacidade diária para que
-- jogos não sejam alocados além do horário limite definido, transbordando para o próximo dia.
