...
DROP TRIGGER IF EXISTS championship_bracket_preview_set_failed_completed_at
ON championship_bracket_preview_private.jobs;

CREATE TRIGGER championship_bracket_preview_set_failed_completed_at
BEFORE INSERT OR UPDATE OF status
ON championship_bracket_preview_private.jobs
FOR EACH ROW
EXECUTE FUNCTION championship_bracket_preview_private.set_failed_preview_job_completed_at();
