ALTER FUNCTION public.get_championship_bracket_preview_job_day(UUID, DATE)
  RENAME TO get_championship_bracket_preview_job_day_v10;

CREATE OR REPLACE FUNCTION championship_bracket_preview_private.resolve_preview_display_match_numbers(
  _job_id UUID
)
RETURNS JSONB
LANGUAGE sql
...
REVOKE ALL ON FUNCTION championship_bracket_preview_private.resolve_preview_display_match_numbers(UUID)
