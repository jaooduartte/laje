...
IS 'Retorna a visão consolidada do chaveamento usando a partida vinculada quando ela existir e a agenda planejada apenas para slots ainda sem partida.';
